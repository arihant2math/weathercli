...
pub fn nws_get_api_urls(location: Vec<String>, _metric: bool) -> crate::Result<String> {
...
pub fn nws_get_combined_data_formatted(location: Vec<String>, metric: bool) -> crate::Result<NWSJSON> {
