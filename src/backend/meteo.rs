...
pub fn meteo_get_api_urls(
    ...
    return if !metric {
        vec![format!("https://api.open-meteo.com/v1/forecast?latitude={}&longitude={}&current_weather=true"
            ...
            "&timezone=auto", longitude, latitude),
             format!("https://air-quality-api.open-meteo.com/v1/air-quality?latitude={}&longitude={}&hourly=european_aqi"
            "", longitude, latitude),
        ]
    } else {
        vec![format!("https://api.open-meteo.com/v1/forecast?latitude={}&longitude={}&current_weather=true"
            ...
            "&daily=temperature_2m_max,temperature_2m_min&timezone=auto", longitude, latitude),
